...
const Footer = () => {
  return (
    <motion.footer
      className="bg-gradient-to-b from-gray-900 via-gray-800 to-black text-gray-300 border-t border-gray-700 py-12 px-6 transition-colors duration-300 w-full"
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
    ...
    >
      <div className="max-w-6xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 text-left">
        {/* Brand */}
        <div>
          <h3 className="text-2xl font-bold text-green-400 mb-2">🥗 NutriAI</h3>
          <p className="text-sm">
        ...
        {/* About */}
        <div>
          <h4 className="text-lg font-semibold text-green-400 mb-2">About Us</h4>
        ...
        {/* Contact */}
        <div>
          <h4 className="text-lg font-semibold text-green-400 mb-2">Contact</h4>
          <ul className="space-y-1 text-sm">
        ...
        {/* Product Info */}
        <div>
          <h4 className="text-lg font-semibold text-green-400 mb-2">Product</h4>
          <ul className="space-y-1 text-sm">
